...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    init: function () {
      ...
      // ensure select is associated with ui_form element if it got unlinked after moving it inside newElement
      if (form && element.form === null) {
        if (!form.id) form.id = 'ui_form-' + this.selectId;
      ...
      if (this.options.liveSearch) {
        searchbox =
          '<div class="bs-searchbox">' +
            '<input type="search" class="ui_form-control" autocomplete="off"' +
              (
    ...
    liHeight: function (refresh) {
      ...
      if (search) {
        ...
        input.className = 'ui_form-control';
