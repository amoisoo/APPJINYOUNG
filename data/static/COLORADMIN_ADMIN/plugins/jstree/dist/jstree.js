...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		 ...
		 * @name create_node([par, node, z_app_pos, callback, is_loaded])
		 ...
		 * @private
		 * @name check(chk, obj, par, z_app_pos)
		 ...
		 * @name move_node(obj, par [, z_app_pos, callback, is_loaded])
		 ...
		 * @name copy_node(obj, par [, z_app_pos, callback, is_loaded])
