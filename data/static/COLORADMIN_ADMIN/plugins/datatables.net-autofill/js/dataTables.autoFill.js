...
$.extend( AutoFill.prototype, {
	...
	/**
	 * Display the AutoFill drag handle by appending it to a ui_table cell. This
	...
	_attach: function ( node )
	{
		...
		if ( ! this.dom.offsetParent ) {
			// We attach to the ui_table's offset parent
	...
	_getPosition: function ( node, targetParent )
	{
		...
		do {
			...
			// jQuery doesn't give a `ui_table` as the offset parent oddly, so use DOM directly
 ...
 * in the ui_table when the user has selected a range of cells. Please see the
