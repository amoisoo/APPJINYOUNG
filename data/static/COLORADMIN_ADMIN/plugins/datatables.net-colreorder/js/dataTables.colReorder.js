 ...
 * ui_table rows). Note this function considers all element nodes under the parent!
 *  @method  fnDomSwitch
...
var ColReorder = function( dt, opts )
{
	...
	// Ensure that we can't initialise on the same ui_table twice
...
$.extend( ColReorder.prototype, {
	 ...
	 *        e.preventDefault();
	 *        $.fn.dataTable.ColReorder( ui_table ).fnReset();
	 *    } );
	 */
	"fnReset": function ()
	{
	 ...
	 *
	 *  @example
	 *    // Get column ordering for the ui_table
	 ...
	 *
	 *  @example
	 *    // Move the first column to the end for the ui_table `#example`
	...
	"_fnOrderColumns": function ( a )
	{
		...
		for ( var i=0, iLen=a.length ; i<iLen ; i++ )
		{
			...
			if ( i != currIndex )
			{
				...
				/* Do the column reorder in the ui_table */
	...
	/**
	 * Because we change the indexes of columns in the ui_table, relative to their starting point
	...
	/**
	 * Mouse down on a TH element in the ui_table header
	 *  @method  _fnMouseDown
	...
	"_fnCreateDragNode": function ()
	{
		...
		// the ui_table with just a single header cell in it.
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the ui_table's column ordering as the end user draws the column
