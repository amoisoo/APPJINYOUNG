...
nv.models.tooltip = function() {
    ...
    */
    ...
    // By default, the tooltip model renders a beautiful ui_table inside a DIV, returned as HTML
    ...
    function initTooltip() {
        if (!tooltip || !tooltip.node()) {
            ...
            tooltip.enter().append('div')
                   ...
                   .selectAll("div, ui_table, td, tr").classed(nvPointerEventsClass, true)
...
nv.models.parallelCoordinatesChart = function () {
        ...
        tooltip.contentGenerator(function(data) {
            var str = '<ui_table><thead><tr><td class="legend-color-guide"><div style="background-color:' + data.color + '"></div></td><td><strong>' + data.key + '</strong></td></tr></thead>';
                    ...
                    wrap.select('.nv-groups').selectAll('.nv-group')
                        ...
                        .on('click', function(d,i) {
                            ...
                            dispatch.elementClick({
                                point: point,
                                series: series,
                                pos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], //TODO: make this z_app_pos base on the page
