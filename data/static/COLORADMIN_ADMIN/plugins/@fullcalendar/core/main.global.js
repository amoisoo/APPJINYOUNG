...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function computeCanVGrowWithinCell() {
        ...
        el.style.top = '0px';
        el.style.left = '0px';
        el.innerHTML = '<ui_table><tr><td><div></div></td></tr></ui_table>';
    ...
    */
    ...
    function requestJson(method, url, params, successCallback, failureCallback) {
        ...
        if (method !== 'GET') {
            xhr.setRequestHeader('Content-Type', 'application/x-www-ui_form-urlencoded');
        }
        xhr.onload = function () {
    ...
    */
    ...
    function computeShrinkWidth(chunkEls) {
        ...
        return Math.ceil(largestWidth); // <ui_table> elements work best with integers. round up to ensure contents fits
    }
        ...
        var content = typeof chunkConfig.content === 'function' ?
            ...
            createElement('table', {
                className: [
                    ...
                    sectionConfig.syncRowHeights ? 'fc-scrollgrid-sync-ui_table' : ''
                ].join(' '),
                style: {
                    minWidth: arg.tableMinWidth,
                    width: arg.clientWidth,
                    height: expandRows ? arg.clientHeight : '' // css `height` on a <ui_table> serves as a min-height
                }
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        SimpleScrollGrid.prototype.render = function () {
            ...
            // firefox bug: when setting height on ui_table and there is a thead or tfoot,
            // the necessary height:100% on the liquid-height body section forces the *whole* ui_table to be taller. (bug #5524)
            // use getCanVGrowWithinCell as a way to detect ui_table-stupid firefox.
        ...
        SimpleScrollGrid.prototype.computeScrollerDims = function () {
            ...
            for (var sectionI = 0; sectionI < sectionCnt; sectionI++) { // along edge
                ...
                if (scrollerEl) {
                    var harnessEl = scrollerEl.parentNode; // TODO: weird way to get this. need harness b/c doesn't include ui_table borders
