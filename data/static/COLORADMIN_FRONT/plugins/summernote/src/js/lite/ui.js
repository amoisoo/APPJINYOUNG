...
const videoDialog = function(opt) {
  const body = '<div class="note-ui_form-group">' +
    '<label for="note-dialog-video-url-' + opt.id + '" class="note-ui_form-label">' + opt.lang.video.url + ' <small class="text-muted">' + opt.lang.video.providers + '</small></label>' +
...
const imageDialog = function(opt) {
  const body = '<div class="note-ui_form-group note-group-select-from-files">' +
    '<label for="note-dialog-image-file-' + opt.id + '" class="note-ui_form-label">' + opt.lang.image.selectFromFiles + '</label>' +
    ...
    opt.imageLimitation +
  '</div>' +
  '<div class="note-ui_form-group">' +
    '<label for="note-dialog-image-url-' + opt.id + '" class="note-ui_form-label">' + opt.lang.image.url + '</label>' +
...
const linkDialog = function(opt) {
  const body = '<div class="note-ui_form-group">' +
    '<label for="note-dialog-link-txt-' + opt.id + '" class="note-ui_form-label">' + opt.lang.link.textToDisplay + '</label>' +
    '<input id="note-dialog-link-txt-' + opt.id + '" class="note-link-text note-input" type="text"/>' +
  '</div>' +
  '<div class="note-ui_form-group">' +
    '<label for="note-dialog-link-url-' + opt.id + '" class="note-ui_form-label">' + opt.lang.link.url + '</label>' +
