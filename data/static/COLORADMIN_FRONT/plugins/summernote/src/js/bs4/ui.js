...
const checkbox = renderer.create('<div class="ui_form-check"></div>', function($node, options) {
  $node.html([
    '<label class="ui_form-check-label"' + (options.id ? ' for="note-' + options.id + '"' : '') + '>',
      '<input type="checkbox" class="ui_form-check-input"' + (options.id ? ' id="note-' + options.id + '"' : ''),
