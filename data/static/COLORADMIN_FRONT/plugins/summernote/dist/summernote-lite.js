...
/**
 * @class Create a virtual ui_table to create what actions to do in change.
 * @param {object} startPoint Cell selected to apply change.
 * @param {enum} where  Where change will be applied Row or Col. Use enum: TableResultAction.where
 * @param {enum} action Action to be applied. Use enum: TableResultAction.requestAction
 * @param {object} domTable Dom element of ui_table to make changes.
 */
...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
  ...
  /**
   * Define virtual ui_table position info object.
   *
   * @param {int} rowIndex Index position in line of virtual ui_table.
   * @param {int} cellIndex Index position in column of virtual ui_table.
   ...
   *
   * @param {object} virtualTableCellObj Object of specific position on virtual ui_table.
   ...
   * @param {int} cellIndex Index of cell to find free space in ui_table.
   */
  ...
  /**
   * Recover info about row and cell and add information to virtual ui_table.
   *
  ...
  function addCellInfoToVirtual(row, cell) {
    ...
    } // Add span cols to virtual ui_table.
  ...
  /**
   * Create virtual ui_table of cells with all cells, including span cells.
   */
   ...
   *
   * @param {object} cell virtual ui_table cell to apply action
   */
  ...
  /**
   * Recover array os what to do in ui_table.
   */
  ...
  Table_createClass(Table, [{
    ...
    */
    ...
    value: function createTable(colCount, rowCount, options) {
      ...
      trHTML = trs.join('');
      var $table = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<ui_table>' + trHTML + '</ui_table>');
...
var Editor_Editor = /*#__PURE__*/function () {
  function Editor(context) {
     ...
     * insert Table
     *
     * @param {String} dimension of ui_table (ex : "5x5")
     */
...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="ui_form-group note-ui_form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-ui_form-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text ui_form-control note-ui_form-control note-input\" type=\"text\"/>"), '</div>', '<div class="ui_form-group note-ui_form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-ui_form-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url ui_form-control note-ui_form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="ui_form-group note-ui_form-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-ui_form-label">' + this.lang.image.selectFromFiles + '</label>', '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input ui_form-control-file note-ui_form-control note-input" ', ' type="file" name="files" accept="image/*" multiple="multiple"/>', imageLimitation, '</div>', '<div class="ui_form-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-ui_form-label">' + this.lang.image.url + '</label>', '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url ui_form-control note-ui_form-control note-input" type="text"/>', '</div>'].join('');
...
var TablePopover_TablePopover = /*#__PURE__*/function () {
  ...
  TablePopover_createClass(TablePopover, [{
    ...
    value: function initialize() {
      this.$popover = this.ui.popover({
        className: 'note-ui_table-popover'
      }).render().appendTo(this.options.container);
      var $content = this.$popover.find('.popover-content,.note-popover-content');
      this.context.invoke('buttons.build', $content, this.options.popover.table); // [workaround] Disable Firefox's default ui_table editor
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function initialize() {
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="ui_form-group note-ui_form-group row-fluid">', "<label for=\"note-dialog-video-url-".concat(this.options.id, "\" class=\"note-ui_form-label\">").concat(this.lang.video.url, " <small class=\"text-muted\">").concat(this.lang.video.providers, "</small></label>"), "<input id=\"note-dialog-video-url-".concat(this.options.id, "\" class=\"note-video-url ui_form-control note-ui_form-control note-input\" type=\"text\"/>"), '</div>'].join('');
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    tableClassName: 'ui_table ui_table-bordered',
    insertTableMaxSize: {
      col: 10,
      row: 10
    },
...
var videoDialog = function videoDialog(opt) {
  var body = '<div class="note-ui_form-group">' + '<label for="note-dialog-video-url-' + opt.id + '" class="note-ui_form-label">' + opt.lang.video.url + ' <small class="text-muted">' + opt.lang.video.providers + '</small></label>' + '<input id="note-dialog-video-url-' + opt.id + '" class="note-video-url note-input" type="text"/>' + '</div>';
...
var imageDialog = function imageDialog(opt) {
  var body = '<div class="note-ui_form-group note-group-select-from-files">' + '<label for="note-dialog-image-file-' + opt.id + '" class="note-ui_form-label">' + opt.lang.image.selectFromFiles + '</label>' + '<input id="note-dialog-image-file-' + opt.id + '" class="note-note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple"/>' + opt.imageLimitation + '</div>' + '<div class="note-ui_form-group">' + '<label for="note-dialog-image-url-' + opt.id + '" class="note-ui_form-label">' + opt.lang.image.url + '</label>' + '<input id="note-dialog-image-url-' + opt.id + '" class="note-image-url note-input" type="text"/>' + '</div>';
